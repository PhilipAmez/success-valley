...
const products = [
  {
    ...
    image:
      'img/fish-fresh-caught-catfish.jpg'
  },
  {
    name: 'Processed Meat',
    ...
    <div className="min-h-screen bg-white text-gray-800 font-sans">
      <header className="sticky top-0 z-50 bg-white/95 backdrop-blur-sm border-b border-gray-200 shadow-sm">
        <div className="mx-auto flex max-w-7xl items-center justify-between px-6 py-4">
          <div>
            <h1 className="text-2xl font-bold text-green-800">SUCCESS VALLEY FARMS</h1>
            ...
            <div className="flex flex-col gap-3">
              {navLinks.map((link) => (
                <button
                  ...
                  className="text-left text-gray-700 hover:text-green-700 font-medium py-2"
                >
                  {link.label}
                </button>
              ))}
              <button
                type="button"
                onClick={() => handleWhatsApp()}
                className="mt-3 rounded-2xl bg-green-700 px-5 py-3 text-white font-semibold shadow-lg hover:bg-green-800"
              >
                Order on WhatsApp
              </button>
            </div>
      ...
      <main>
          ...
          <div className="relative z-10 mx-auto max-w-3xl px-6 text-white">
            ...
            <div className="flex flex-col gap-4 sm:flex-row">
              <button
                ...
                className="bg-green-700 hover:bg-green-800 px-6 py-4 rounded-2xl text-lg font-semibold shadow-xl transition"
              >
                View Products
              </button>
              <button
        ...
        <section className="grid gap-6 px-6 py-14 md:grid-cols-4 md:px-8 bg-green-950 text-white">
        ...
        <section id="about" className="max-w-7xl mx-auto grid gap-10 px-6 py-20 md:grid-cols-2 md:px-8">
          ...
          <div className="flex flex-col justify-center">
            ...
            <h2 className="text-3xl md:text-5xl font-bold mb-6 text-green-950">
            ...
            <button
              ...
              className="bg-green-700 hover:bg-green-800 text-white px-6 py-4 rounded-2xl shadow-lg transition"
            >
              Learn More
            </button>
          </div>
        ...
        <section id="contact" className="py-20 px-6 bg-green-900 text-white text-center">
          <div className="max-w-3xl mx-auto">
            ...
            <div className="flex flex-col gap-4 sm:flex-row sm:justify-center sm:gap-5">
              <button
                type="button"
                onClick={handleCall}
                className="bg-white text-green-900 px-8 py-4 rounded-2xl font-bold shadow-lg hover:bg-gray-100 transition"
              >
                Call Now
              </button>
              <button
                type="button"
                onClick={() => handleWhatsApp()}
                className="bg-green-700 px-8 py-4 rounded-2xl font-bold shadow-lg hover:bg-green-800 transition"
              >
                WhatsApp Us
              </button>
            </div>
